...
$(function(){
	...
	$( "#add-form" ).submit( function( event ){
		...
		var name = $("#name").val();
		if(name == ""){
			messageBox("글 남기기", "이름은 필수 입력 항목입니다.","name");
			return;
		}
		var password = $("#password").val();
		if(password == ""){
			messageBox("글 남기기", "비밀번호는 필수 입력 항목입니다.","password");
			return;
		}
		var message = $("#message").val();
		if(message == ""){
			messageBox("글 남기기", "내용은 필수 입력 항목입니다.","message");
			return;
		}
		...
		<div id="content">
			<div id="guestbook">
				...
				<form id="add-form" action="" method="post">
					...
					<textarea id="message" name="message" placeholder="내용을 입력해 주세요."></textarea>
